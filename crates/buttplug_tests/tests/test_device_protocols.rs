...
#[test_case("test_hismith_sinloli_aston.yaml" ; "Hismith Mini Protocol - Sinloli Aston")]
...
//#[test_case("test_honeyplaybox_protocol.yaml" ; "HoneyPlayBox Protocol - VIBROSA")]
#[test_case("test_itoys_protocol.yaml" ; "iToys Protocol")]
#[test_case("test_itoys_twinklingstars.yaml" ; "iToys Protocol - Twinkling Stars")]
...
#[test_case("test_kiiroo_powershot.yaml" ; "Kiiroo PowerShot Protocol")]
...
#[test_case("test_sexverse_cali.yaml" ; "Sexverse Protocol v1 - Cali")]
#[test_case("test_sexverse_nolan.yaml" ; "Sexverse Protocol v2 - Nolan")]
#[test_case("test_sexverse_olis.yaml" ; "Sexverse Protocol v1 - Olis")]
#[test_case("test_sexverse_rex.yaml" ; "Sexverse Protocol v1 - Rex")]
...
#[test_case("test_sexverse_heart_protocol.yaml" ; "Sexverse Heart Protocol")]
...
#[test_case("test_vvd_vkini_protocol.yaml" ; "VVD Vikini (metaXsire v4) Protocol")]
...
#[test_case("test_magic_motion_4_nyx.yaml" ; "MagicMotion Protocol 4 - Nyx")]
#[test_case("test_meese_protocol.yaml" ; "Meese Protocol")]
#[test_case("test_sexverse_cali.yaml" ; "metaXsire Protocol - Cali")]
#[test_case("test_sexverse_nolan.yaml" ; "metaXsire Protocol v2 - Nolan")]
#[test_case("test_sexverse_olis.yaml" ; "metaXsire Protocol - Olis")]
#[test_case("test_sexverse_rex.yaml" ; "metaXsire Protocol - Rex")]
#[test_case("test_mizzzee_protocol.yaml" ; "Mizz Zee Protocol")]
#[test_case("test_mizzzee_v2_protocol.yaml" ; "Mizz Zee v2 Protocol")]
#[test_case("test_mizzzee_v3_protocol.yaml" ; "Mizz Zee v3 Protocol")]
#[test_case("test_motorbunny_protocol.yaml" ; "Motorbunny Protocol")]
...
// V1 supports VibrateCmd, RotateCmd, LinearCmd, StopDeviceCmd (same as v2 minus Battery).
// Battery tests are now VersionGated(min: 2) in YAML so they are skipped cleanly.
//#[test_case("test_cowgirl_cone_protocol.yaml" ; "The Cowgirl Cone Protocol")]
#[test_case("test_activejoy_protocol.yaml" ; "ActiveJoy Protocol")]
#[test_case("test_adrienlastic_protocol.yaml" ; "Adrien Lastic Protocol")]
#[test_case("test_amorelie_joy_protocol.yaml" ; "Amorelie Joy Protocol")]
...
async fn test_device_protocols_embedded_v1(test_file: &str) {
  //tracing_subscriber::fmt::init();
  util::device_test::client::client_v1::run_embedded_test_case(&load_test_case(test_file).await)
    .await;
}

// V1 JSON transport tests
//#[test_case("test_cowgirl_cone_protocol.yaml" ; "The Cowgirl Cone Protocol")]
#[test_case("test_activejoy_protocol.yaml" ; "ActiveJoy Protocol")]
#[test_case("test_adrienlastic_protocol.yaml" ; "Adrien Lastic Protocol")]
#[test_case("test_amorelie_joy_protocol.yaml" ; "Amorelie Joy Protocol")]
